...
leftHipLegConnectionJoint = gr.joint('leftHipLegConnectionJoint', {-45, 0, 45}, {-90, 0, 90})
leftHipLegConnectionJoint:translate(0.0, 0.0, 0.0)
leftHipLegConnection:add_child(leftHipLegConnectionJoint)

rightHipLegConnectionJoint = gr.joint('rightHipLegConnectionJoint', {-45, 0, 45}, {-90, 0, 90})
